...
import com.rodilon.unittesting.util.LiveDataTestUtil;
import com.rodilon.unittesting.util.TestUtil;
...
public class NoteDaoTest extends NoteDatabaseTest {
    ...
    public static final String TEST_CONTENT = "This is a test contet";
