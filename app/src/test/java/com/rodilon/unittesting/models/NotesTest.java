package com.rodilon.unittesting.models;
...
public class NotesTest {
    ...
    void isNotesEqual_differentTitles_returnFalse() throws Exception {
        ...
        // Assert
        assertNotEquals(note1, note2);
        System.out.println("The notes are not equal! They have a different titles.");
    }
    ...
    void isNotesEqual_differentContent_returnFalse() throws Exception {
        ...
        // Assert
        assertNotEquals(note1, note2);
        System.out.println("The notes are not equal! They have a different content.");
    }
}
